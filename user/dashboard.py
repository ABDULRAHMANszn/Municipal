...
from PyQt5.QtWidgets import QApplication, QMainWindow, QFrame, QLabel, QStackedWidget, QPushButton, QWidget
...
class Main(QWidget):
    def __init__(self, parent_frame):
        ...
        self.create_fun_card(90, 130, "../images/Su.jpeg", "Water Subscription", "Subscribe")
        ...
        self.create_fun_card(90, 420, "../images/gas.jpg", "Gas Subscription", "Subscribe")
        self.create_fun_card(340, 420, "../images/visa.jpg", "Visa Digital", "Subscribe")
        self.create_fun_card(590, 420, "../images/statf.jpeg", "Staff", "View")

    def create_fun_card(self, x, y, image_path, title_text, button_text):
        card = QFrame(self)
...
class Dashboard(QMainWindow):
    ...
    def setup_form(self):
        ...
        pixmap = QPixmap("../images/icon2-Photoroom.png")
